...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let currentCase = NSTextField(frame: .zero)
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        self.window?.close()
        self.window = nil
        intFields = [(currentStep, "currentStep"), (someNumber, "someNumber"), (currentCase, "currentCase")]
        tupleFields = [n1Fields, n2Fields, n3Fields]
        ...
        addLabel(to: v, align: .right, autoSz: .minYMargin, x: x + 230, y: y - 3, w: 85, text: "Case")
        addField(currentCase, to: v, autoSz: .minYMargin, x: x + 320, y: y, w: 40)
    ...
    @objc func onRun() {
        ...
        PathAlg.alg.currentCase = currentCase.integerValue
        info?.string = ""
        ...
        if let n1I = readInterval(n1Fields), let n2I = readInterval(n2Fields), let n3I = readInterval(n3Fields) {
            n1Interval = n1I
            n2Interval = n2I
            n3Interval = n3I
        } else { return }
    ...
    private func startCase() {
        ...
        let finishMe: Bool
        switch PathAlg.alg.currentCase {
        case 1: finishMe = n1Zero
        case 2: finishMe = PathAlg.rkC != 2 || !n1Zero
        case 3: finishMe = PathAlg.rkC != 1
        case 4: finishMe = PathAlg.rkC != 0
        default: finishMe = false
        }
        if finishMe {
            performSelector(onMainThread: #selector(finishCase), with: nil, waitUntilDone: false)
            return
        }
        addInfoStr("n1=\(PathAlg.n1), n2=\(PathAlg.n2), n3=\(PathAlg.n3)")
