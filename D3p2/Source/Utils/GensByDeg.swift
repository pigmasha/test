...
struct GensByDeg {
    ...
    private static var deg0Gens: [[String]] {
        var result: [[String]] = [["1"], ["p1"], ["p2"], ["p3"]]
        add(from: 1, to: PathAlg.n3 - 1, c: "c1", g: [], to: &result)
        add(from: 1, to: PathAlg.n1 - 1, c: "c2", g: [], to: &result)
        add(from: 1, to: PathAlg.n2 - 1, c: "c3", g: [], to: &result)
        return result
    }
