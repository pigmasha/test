...
final class ShiftHHElem09 : ShiftHHElem {
    ...
    override func koef11(s: Int, ell: Int) -> Int {
        ...
        let x: Int
        switch s {
        case 5: x = ell_s == 3 ? -1 : 1
        case 7: x = ell_s == 2 || ell_s == 3 || ell_s == 5 ? -1 : 1
        case 11: x = ell_s == 1 || ell_s >= 8 ? -1 : 1
        case 13: x = ell_s == 1 || ell_s == 2 || ell_s >= 9 ? -1 : 1
        case 17: x = ell_s == 3 || ell_s == 5 || ell_s == 7 || ell_s == 8 || ell_s == 10 || ell_s == 12 || ell_s == 15 ? -1 : 1
        case 19: x = ell_s == 2 || ell_s == 3 || ell_s == 5 || ell_s == 7 || ell_s == 10 || ell_s == 12 ||
            ell_s == 14 || ell_s == 15 || ell_s == 17 ? -1 : 1
        default: x = ell_s == 3 ? -1 : 1
        }
        return minusDeg(ell / s) * x
    }
}
