...
//#if SHIFTS
final class ShiftHHElem27 : ShiftHHElem {
    override func shift0(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        hhElem.makeZeroMatrix(9*s, h:8*s)

        for j in 0 ..< 5*s {
            let j_2 = j / s
            HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+j_2, leftTo:8*(j+m)+7+j_2, rightFrom:8*j+j_2, rightTo:8*j+j_2, koef:1)
        }
        for j in 7*s ..< 8*s {
            HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+4, rightFrom:8*j+7, rightTo:8*j+7, koef:-1)
        }
    }
    ...
    override func shift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 0 ..< s {
            HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+3, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:1)
            HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+2, koef:1)
            HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+3, koef:1)
        }
        for j in 5*s ..< 6*s {
    ...
    override func shift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 5*s ..< 6*s {
            HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+2), rightFrom:8*j+4, rightTo:8*(j+1), koef:-1)
        }
        for j in 8*s ..< 9*s {
            HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+4, leftTo:8*(j+m+2)+1, rightFrom:8*j+7, rightTo:8*(j+1)+1, koef:-1)
            HHElem.addElemToHH(hhElem, i:4*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+7, leftTo:8*(j+m+2)+1, rightFrom:8*j+7, rightTo:8*(j+1)+2, koef:-1)
        }
    }
    ...
    override func shift8(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 2*s ..< 3*s {
            HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+4, rightFrom:8*j+1, rightTo:8*(j+1), koef:1)
        }
        for j in 6*s ..< 7*s {
    ...
    override func shift9(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 2*s ..< 3*s {
            ...
            HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        }
        for j in 3*s ..< 4*s {
    ...
    override func shift10(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 4*s ..< 5*s {
            HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+6, rightFrom:8*j+2, rightTo:8*(j+1), koef:-1)
        }
    }
    ...
    override func shift11(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 0 ..< s {
            HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        }
        for j in 2*s ..< 3*s {
        ...
        for j in 5*s ..< 6*s {
            HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+7, rightFrom:8*j+2, rightTo:8*(j+1), koef:-1)
        }
        for j in 6*s ..< 7*s {
    ...
    override func shift12(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 7*s ..< 8*s {
            ...
            HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j+3, rightTo:8*(j+1), koef:1)
        }
    }
    ...
    override func shift15(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in s ..< 2*s {
            HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+3, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        }
        for j in 3*s ..< 4*s {
        ...
        for j in 4*s ..< 5*s {
            HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+2), rightFrom:8*j+1, rightTo:8*(j+1), koef:1)
        }
        for j in 5*s ..< 6*s {
            HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+7, rightFrom:8*j+2, rightTo:8*(j+1), koef:1)
        }
    ...
    override func shift21(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in s ..< 2*s {
            HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        }
        for j in 4*s ..< 5*s {
        ...
        for j in 6*s ..< 7*s {
            ...
            HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+7, leftTo:8*(j+m+2), rightFrom:8*j+3, rightTo:8*(j+1)+1, koef:-1)
        }
        for j in 15*s ..< 16*s {
    ...
    override func shift22(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 2*s ..< 3*s {
            HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+2, rightFrom:8*j+1, rightTo:8*(j+1), koef:1)
        }
        for j in 3*s ..< 4*s {
    ...
    override func shift24(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in 0 ..< s {
            HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
            HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+1, koef:1)
        }
        for j in 2*s ..< 3*s {
