...
final class ShiftHHElem19c : ShiftHHElem {
    ...
    override func oddShift1(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 4*s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+2), rightFrom:8*j+1, rightTo:8*(j+1), koef:1)
        j += s
    ...
    override func oddShift9(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+1)+7, rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift11(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+2), rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift12(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
    }
    ...
    override func oddShift13(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+1)+7, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+1)+7, rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift15(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+4, leftTo:8*(j+m+1)+7, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
    }
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+3, rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift17(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+7, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+2), rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
    }
    ...
    override func oddShift18(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 0
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+2, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        j += 2*s
    ...
    override func oddShift28(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+2, rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+4, rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
    }
}
//#endif /* SHIFTS */
