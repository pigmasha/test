...
//#if SHIFTS
final class ShiftHHElem35 : ShiftHHElem {
    ...
    override func shift1(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 6*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*j+5, koef:1, noZeroLenL:true)
    }
    ...
    override func shift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j, koef:1, noZeroLenL:true)
    }
    ...
    override func shift4(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 5*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+4, rightTo:8*j+4, koef:1, noZeroLenL:true)
    }
    ...
    override func shift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 10*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+7, rightTo:8*j+7, koef:1, noZeroLenL:true)
    }
    ...
    override func shift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 4*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+3, rightTo:8*j+3, koef:1, noZeroLenL:true)
        j = 10*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+6, koef:1, noZeroLenL:true)
    }
    ...
    override func shift8(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 4*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+2, rightTo:8*j+2, koef:1, noZeroLenL:true)
        j = 10*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*j+5, koef:1, noZeroLenL:true)
    }
    ...
    override func shift10(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 3*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+1, rightTo:8*j+1, koef:1, noZeroLenL:true)
        j = 9*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+4, rightTo:8*j+4, koef:1, noZeroLenL:true)
        j = 14*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+6, koef:1, noZeroLenL:true)
