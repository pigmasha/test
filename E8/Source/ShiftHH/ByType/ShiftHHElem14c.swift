...
final class ShiftHHElem14c : ShiftHHElem {
    ...
    override func oddShift1(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        hhElem.makeZeroMatrix(20*s, h:9*s)

        var j = 0
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j += s
        ...
        j = 11*s
        HHElem.addElemToHH(hhElem, i:j-5*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*j+5, koef:-1, noZeroLenL:true)
        j = 12*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+3, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j += 6*s
    ...
    override func oddShift2(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j-5*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j+3, rightTo:8*j+3, koef:-1)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j-6*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m+1), rightFrom:8*j+6, rightTo:8*j+6, koef:1)
    }
    ...
    override func oddShift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+2, koef:1)
        j += 2*s
        ...
        j += 3*s
        HHElem.addElemToHH(hhElem, i:j-3*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+2, rightFrom:8*j+3, rightTo:8*j+3, koef:-1)
        j += s
    ...
    override func oddShift4(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m)+7, rightFrom:8*j+3, rightTo:8*j+4, koef:1)
        j = 9*s + myModS(-2)
    ...
    override func oddShift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j = 3*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+1, rightTo:8*(j+1), koef:-1)
        j = 3*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+1, rightTo:8*(j+1), koef:-1)
        j += 2*s
    ...
    override func oddShift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m)+3, rightFrom:8*j, rightTo:8*j+4, koef:-1)
        ...
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m)+7, rightFrom:8*j+2, rightTo:8*j+3, koef:-1)
        j = 8*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j = 8*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
    ...
    override func oddShift8(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m)+4, rightFrom:8*j, rightTo:8*j+2, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+3, leftTo:8*(j+m)+4, rightFrom:8*j, rightTo:8*j+4, koef:-1)
    ...
    override func oddShift9(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+2, koef:1)
        HHElem.addElemToHH(hhElem, i:j+7*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+5, koef:1)
        j = 2*s + myModS(-2)
    ...
    override func oddShift11(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(-1)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j, koef:1)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j, koef:1)
        ...
        HHElem.addElemToHH(hhElem, i:j+8*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+4, koef:-1)
    ...
    override func oddShift12(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m)+4, rightFrom:8*j, rightTo:8*j+3, koef:1)
        HHElem.addElemToHH(hhElem, i:j+10*s, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m)+4, rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j += s
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+2, rightFrom:8*j+4, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+1)+2, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j = 6*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
    ...
    override func oddShift14(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        hhElem.makeZeroMatrix(9*s, h:20*s)
        ...
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+1, koef:1)
        HHElem.addElemToHH(hhElem, i:j+12*s, j:j, leftFrom:8*(j+m)+3, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j = s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1), rightFrom:8*j+1, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j+1, rightTo:8*(j+1), koef:-1)
        j = s + myModS(-1)
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+1)+3, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j = 5*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:4*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+6, rightFrom:8*j+7, rightTo:8*(j+1)+1, koef:1)
    }
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+1, koef:1)
        j = myModS(-1)
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:2, noZeroLenR:true)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+1, koef:1)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+1, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+11*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j = s + myModS(-2)
        ...
        HHElem.addElemToHH(hhElem, i:6*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+3, rightFrom:8*j+3, rightTo:8*(j+1)+2, koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+4, leftTo:8*(j+m+1)+4, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:1)
        HHElem.addElemToHH(hhElem, i:6*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+4, rightFrom:8*j+4, rightTo:8*(j+1)+2, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j = 5*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j = 6*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:12*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*(j+1)+5, koef:-1)
        j += s
        ...
        HHElem.addElemToHH(hhElem, i:11*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+4, leftTo:8*(j+m+1)+7, rightFrom:8*j+7, rightTo:8*(j+1)+5, koef:1)
    }
    ...
    override func oddShift17(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(-2)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        j = myModS(-1)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+10*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+5, koef:1)
        j = s + myModS(-2)
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j = 7*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:10*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+7, leftTo:8*(j+m+1)+7, rightFrom:8*j+6, rightTo:8*(j+1)+5, koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:4*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+7, leftTo:8*(j+m+2), rightFrom:8*j+7, rightTo:8*(j+1)+1, koef:-1)
    ...
    override func oddShift18(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:5*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+1)+4, rightFrom:8*j+3, rightTo:8*(j+1)+2, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:-1)
        j = 4*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:-1)
        j = 5*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j = 5*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
    }
    ...
    override func oddShift19(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j+8*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j += s
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:4*s+myModS(j+1), j:j, leftFrom:8*(j+m+2), leftTo:8*(j+m+2), rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j = 6*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        j = 8*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:4*s+myModS(j+1), j:j, leftFrom:8*(j+m+2), leftTo:8*(j+m+2)+1, rightFrom:8*j+7, rightTo:8*(j+1)+1, koef:1)
    }
    ...
    override func oddShift20(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+4, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+7*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j = 2*s + myModS(-2)
        ...
        j = 3*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+4, rightFrom:8*j+2, rightTo:8*(j+1), koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j+3, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:6*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+3, rightTo:8*(j+1)+3, koef:-1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+4, rightTo:8*(j+1)+1, koef:-1)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m+1)+1, rightFrom:8*j+5, rightTo:8*j+5, koef:-1, noZeroLenL:true)
        j = 7*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m+1)+1, rightFrom:8*j+5, rightTo:8*j+5, koef:-1, noZeroLenL:true)
    }
    ...
    override func oddShift21(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(-1)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+2, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+3, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+4, koef:-1)
        HHElem.addElemToHH(hhElem, i:j+9*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+6, koef:-1)
        j = s + myModS(-2)
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j, koef:1)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:1)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+2, koef:1)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+3, koef:1)
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+4, koef:1)
        HHElem.addElemToHH(hhElem, i:j+7*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+6, koef:1)
        j = 2*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j, koef:1)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+1, koef:1)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j, rightTo:8*j+2, koef:1)
        ...
        j += 2*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+2), rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+2), rightFrom:8*j+5, rightTo:8*(j+1), koef:-1)
    }
    ...
    override func oddShift22(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+1, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+4, koef:1)
        HHElem.addElemToHH(hhElem, i:j+7*s, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+5, koef:1)
        j = myModS(-1)
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+6, rightFrom:8*j+3, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:5*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+3, rightTo:8*(j+1)+3, koef:1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j+3, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j+3, rightTo:8*(j+1), koef:-1)
        j = 5*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j+3, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+1, rightFrom:8*j+3, rightTo:8*(j+1), koef:-1)
        j = 6*s + myModS(-2)
        ...
        HHElem.addElemToHH(hhElem, i:6*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+1, leftTo:8*(j+m+1)+2, rightFrom:8*j+4, rightTo:8*(j+1)+4, koef:1, noZeroLenR:true)
        j = 7*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+2, leftTo:8*(j+m+1)+2, rightFrom:8*j+5, rightTo:8*j+5, koef:-1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:7*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1)+5, koef:1)
        j = 9*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1), koef:1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1), koef:-1)
        HHElem.addElemToHH(hhElem, i:7*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+2, leftTo:8*(j+m+1)+3, rightFrom:8*j+6, rightTo:8*(j+1)+5, koef:1)
    ...
    override func oddShift23(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j = 3*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        j = 3*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        j = 4*s + myModS(-2)
        ...
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+7, rightFrom:8*j+1, rightTo:8*(j+1), koef:1)
        j = 5*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+2), leftTo:8*(j+m+2), rightFrom:8*j+2, rightTo:8*(j+1)+1, koef:1)
        j += s
        ...
        j += 2*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1)+3, leftTo:8*(j+m+1)+7, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j += 4*s
    ...
    override func oddShift24(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:-1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+1, rightTo:8*j+1, koef:-1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+1, rightTo:8*(j+1)+1, koef:1, noZeroLenR:true)
        j = 3*s + myModS(-1)
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:8*(j+m)+5, leftTo:8*(j+m+1)+5, rightFrom:8*j+1, rightTo:8*j+1, koef:-1, noZeroLenL:true)
        j = 4*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+5, leftTo:8*(j+m+1)+6, rightFrom:8*j+2, rightTo:8*(j+1)+1, koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+1, rightFrom:8*j+2, rightTo:8*(j+1), koef:-1)
        j += s
        ...
        j += 3*s
        HHElem.addElemToHH(hhElem, i:j-3*s, j:j, leftFrom:8*(j+m)+3, leftTo:8*(j+m+1)+3, rightFrom:8*j+5, rightTo:8*j+5, koef:1, noZeroLenL:true)
    }
    ...
    override func oddShift25(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(-2)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+1, koef:1)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+2, koef:1)
        HHElem.addElemToHH(hhElem, i:j+7*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+5, rightFrom:8*j, rightTo:8*j+6, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1)+3, rightFrom:8*j, rightTo:8*j, koef:-1)
    ...
    override func oddShift26(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*(j+1), koef:1, noZeroLenR:true)
        for j_1 in 1 ... 4 {
            HHElem.addElemToHH(hhElem, i:j+j_1*s, j:j, leftFrom:8*(j+m)+j_1, leftTo:8*(j+m+1), rightFrom:8*j, rightTo:8*j+j_1+1, koef:-1+2*f(j_1,2))
        }
        j = 3*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+1, rightTo:8*(j+1)+1, koef:1, noZeroLenR:true)
        j = 5*s + myModS(-2)
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+7, rightFrom:8*j+7, rightTo:8*(j+1), koef:1, noZeroLenL:true)
        for j_1 in 1 ... 4 {
            HHElem.addElemToHH(hhElem, i:(j_1+1)*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+j_1, leftTo:8*(j+m+1)+7, rightFrom:8*j+7, rightTo:8*(j+1)+1+j_1, koef:1-2*f(j_1,2))
        }
    }
    ...
    override func oddShift27(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+4, rightFrom:8*j, rightTo:8*j+5, koef:-1)
        j = 5*s + myModS(-3)
    ...
    override func oddShift28(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += 2*s
        for j_1 in 1 ... 7 {
            HHElem.addElemToHH(hhElem, i:j+(j_1-2)*s, j:j, leftFrom:8*(j+m)+j_1, leftTo:8*(j+m)+7, rightFrom:8*j, rightTo:8*j+j_1, koef:-1+2*(f(j_1,1)+f(j_1,3)+f(j_1,6)))
        }
        j = 3*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+2, rightFrom:8*j+1, rightTo:8*(j+1), koef:-1)
        j = 4*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:8*(j+m)+3, leftTo:8*(j+m+1)+3, rightFrom:8*j+2, rightTo:8*j+3, koef:-1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1)+3, rightFrom:8*j+2, rightTo:8*j+4, koef:1)
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+3, rightFrom:8*j+2, rightTo:8*j+7, koef:1)
        j = 4*s + myModS(-3)
        ...
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+3, rightFrom:8*j+2, rightTo:8*j+7, koef:1)
        j = 6*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1)+4, rightFrom:8*j+3, rightTo:8*j+4, koef:-1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+4, rightFrom:8*j+3, rightTo:8*j+7, koef:-1)
        j = 6*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:8*(j+m)+4, leftTo:8*(j+m+1)+4, rightFrom:8*j+3, rightTo:8*j+4, koef:-1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+4, rightFrom:8*j+3, rightTo:8*j+7, koef:-1)
        j += 4*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:8*(j+m+1), leftTo:8*(j+m+1)+2, rightFrom:8*j+5, rightTo:8*(j+1), koef:1)
        j += s
        ...
        HHElem.addElemToHH(hhElem, i:j-4*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j+5, rightTo:8*j+7, koef:-1)
        j = 13*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:j-7*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+6, koef:1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j-6*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+7, koef:-1)
        j = 13*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:j-7*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+6, koef:1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j-6*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j+6, rightTo:8*j+7, koef:-1)
        j = 16*s + myModS(-2)
        HHElem.addElemToHH(hhElem, i:j-9*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+7, rightFrom:8*j+7, rightTo:8*j+7, koef:1, noZeroLenL:true)
        j = 16*s + myModS(-3)
        HHElem.addElemToHH(hhElem, i:j-9*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+7, rightFrom:8*j+7, rightTo:8*j+7, koef:1, noZeroLenL:true)
        j += 2*s
        for j_1 in 1 ... 7 {
            HHElem.addElemToHH(hhElem, i:j_1*s+myModS(j+1), j:j, leftFrom:8*(j+m+1)+j_1, leftTo:8*(j+m+2), rightFrom:8*j+7, rightTo:8*(j+1)+j_1, koef:-1+2*(f(j_1,1)+f(j_1,3)+f(j_1,6)), noZeroLenR:true)
        }
    }
