...
//#if SHIFTS
final class ShiftHHElem04c : ShiftHHElem {
    ...
    override func oddShift28(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:8*(j+m)+6, leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j+6, koef:-1, noZeroLenL:true)
        HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:8*(j+m)+7, leftTo:8*(j+m+1)+6, rightFrom:8*j, rightTo:8*j+7, koef:1)
    }
