...
final class ShiftHHElem10c : ShiftHHElem {
    ...
    override func oddShift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 2*s + myModS(3)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+1, leftTo:7*(j+m+1)+1, rightFrom:7*j+2, rightTo:7*j+2, koef:1)
    }
    ...
    override func oddShift10(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+2, rightTo:7*j+2, koef:-1)
    }
    ...
    override func oddShift13(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:7*(j+m+2), leftTo:7*(j+m+2)+4, rightFrom:7*j+2, rightTo:7*(j+1)+2, koef:-1)
    }
    ...
    override func oddShift14(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
        j += s
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 2*s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+2, rightTo:7*j+6, koef:-1)
    }
