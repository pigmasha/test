...
final class ShiftHHElem03c : ShiftHHElem {
    ...
    override func oddShift1(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:5*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+5, leftTo:7*(j+m+1)+5, rightFrom:7*j+4, rightTo:7*(j+1)+4, koef:1)
        j += s
    ...
    override func oddShift3(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+1, rightTo:7*(j+1)+1, koef:1)
        j += s
    ...
    override func oddShift16(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+1, leftTo:7*(j+m+1)+1, rightFrom:7*j+1, rightTo:7*j+1, koef:1)
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+2, leftTo:7*(j+m+1)+2, rightFrom:7*j+2, rightTo:7*j+2, koef:1)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+2, rightFrom:7*j+2, rightTo:7*j+3, koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+3, rightTo:7*j+3, koef:1)
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+4, leftTo:7*(j+m+1)+4, rightFrom:7*j+4, rightTo:7*j+4, koef:1)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+5, leftTo:7*(j+m+1)+4, rightFrom:7*j+4, rightTo:7*j+5, koef:-1)
        j += s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+5, leftTo:7*(j+m+1)+5, rightFrom:7*j+5, rightTo:7*j+5, koef:1)
        j += 2*s - 1
