...
final class ShiftHHElem22 : ShiftHHElem {
    ...
    override func shift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+1, rightTo:7*j+1, koef:1, noZeroLenL:true)
    }
    ...
    override func shift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j, rightTo:7*j, koef:1, noZeroLenL:true)
    }
    ...
    override func shift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 8*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+5, rightTo:7*j+5, koef:1, noZeroLenL:true)
    }
    ...
    override func shift7(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 10*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+6, rightTo:7*j+6, koef:1, noZeroLenL:true)
    }
    ...
    override func shift8(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+3, rightTo:7*j+3, koef:1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+4, rightTo:7*j+4, koef:1, noZeroLenL:true)
    }
