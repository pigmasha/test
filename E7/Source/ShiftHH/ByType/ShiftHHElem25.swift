...
final class ShiftHHElem25 : ShiftHHElem {
    override func shift0(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 6*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+6, rightTo:7*j+6, koef:1, noZeroLenL:true)
    }
    ...
    override func shift1(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 4*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+3, rightTo:7*j+3, koef:1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+5, rightTo:7*j+5, koef:1, noZeroLenL:true)
    }
    ...
    override func shift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 3*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+2, rightTo:7*j+2, koef:1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+4, rightTo:7*j+4, koef:1, noZeroLenL:true)
    }
    ...
    override func shift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 3*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+1, rightTo:7*j+1, koef:1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+3, rightTo:7*j+3, koef:1, noZeroLenL:true)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+5, rightTo:7*j+5, koef:1, noZeroLenL:true)
