...
final class ShiftHHElem11c : ShiftHHElem {
    ...
    override func oddShift3(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j = s + myModS(3)
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+1, rightTo:7*j+1, koef:1, noZeroLenL:true)
        j = 5*s + myModS(3)
    ...
    override func oddShift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+1, leftTo:7*(j+m+1)+1, rightFrom:7*j+2, rightTo:7*(j+1)+2, koef:-1, noZeroLenR:true)
        j += s
    ...
    override func oddShift9(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(2)
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+1, leftTo:7*(j+m+1)+1, rightFrom:7*j, rightTo:7*(j+1), koef:-1, noZeroLenR:true)
        j += 2*s
    ...
    override func oddShift10(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+2, rightTo:7*j+2, koef:-1, noZeroLenL:true)
        j = 4*s + myModS(2)
    ...
    override func oddShift11(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = myModS(1)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+2, leftTo:7*(j+m+1)+2, rightFrom:7*j, rightTo:7*(j+1), koef:1, noZeroLenR:true)
        j = myModS(2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+2, leftTo:7*(j+m+1)+2, rightFrom:7*j, rightTo:7*(j+1), koef:1, noZeroLenR:true)
        HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+2, rightFrom:7*j, rightTo:7*j+1, koef:1)
        j = s + myModS(2)
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+4, leftTo:7*(j+m+1)+5, rightFrom:7*j, rightTo:7*(j+1), koef:1, noZeroLenR:true)
        j = 2*s + myModS(1)
        ...
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+2, rightTo:7*(j+1)+2, koef:-1, noZeroLenR:true)
        j = 4*s + myModS(1)
    ...
    override func oddShift13(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        for j in (s <= 2 ? 0 : 1) ..< min(s, 3) {
            HHElem.addElemToHH(hhElem, i:j+2*s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*j+1, koef:s==1 ? 2 : 1)
            HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*j+2, koef:s==1 ? 2 : 1)
            HHElem.addElemToHH(hhElem, i:j+6*s, j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*j+5, koef:s==1 ? 2 : 1)
        }
        for j in s ..< s + min(s, 3) {
            HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j, rightTo:7*(j+1), koef:s==1 ? 3 : (s==2 && j==s ? 2 : 1), noZeroLenR:true)
        }
        var j = 3*s
        ...
        HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:7*(j+m+2), leftTo:7*(j+m+2), rightFrom:7*j+2, rightTo:7*(j+1)+2, koef:-1, noZeroLenR:true)
        j = 6*s + myModS(2)
    ...
    override func oddShift14(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m)+6, rightFrom:7*j, rightTo:7*(j+1), koef:s==1 ? 3 : 1, noZeroLenR:true)
        if s == 1 {
            HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+5, leftTo:7*(j+m)+6, rightFrom:7*j, rightTo:7*j+1, koef:2)
            HHElem.addElemToHH(hhElem, i:j+5*s, j:j, leftFrom:7*(j+m)+4, leftTo:7*(j+m)+6, rightFrom:7*j, rightTo:7*j+5, koef:2)
        }
        for j in (s == 2 ? 0 : 1) ..< min(s, 3) {
        ...
        for j in s ..< s + min(s, 2) {
            HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1), rightFrom:7*j, rightTo:7*(j+1), koef:s==1 ? 2 : 1, noZeroLenR:true)
        }
        for j in 2*s ..< 2*s + min(s, 2) {
            HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+4, rightFrom:7*j+1, rightTo:7*(j+1), koef:s==1 ? 2 : 1)
        }
        j = 3*s + myModS(1)
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1), rightFrom:7*j, rightTo:7*(j+1), koef:1, noZeroLenR:true)
        j = 2*s
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:7*(j+m)+1, leftTo:7*(j+m+1)+1, rightFrom:7*j+1, rightTo:7*j+1, koef:-1, noZeroLenL:true)
        ...
        for j in 4*s ..< 4*s + min(s, 2) {
            ...
            HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+2, leftTo:7*(j+m+1)+2, rightFrom:7*j+2, rightTo:7*(j+1)+2, koef:1, noZeroLenR:true)
        }
        j = 4*s
        ...
        for j in 5*s ..< 5*s + min(s, 3) {
            HHElem.addElemToHH(hhElem, i:j-2*s, j:j, leftFrom:7*(j+m)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+3, rightTo:7*j+3, koef:s == 2 && j == 5*s ? -2 : -1, noZeroLenL:true)
            if j < 5*s + min(s, 2) {
                HHElem.addElemToHH(hhElem, i:3*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+3, leftTo:7*(j+m+1)+3, rightFrom:7*j+3, rightTo:7*(j+1)+3, koef:1, noZeroLenR:true)
            }
        ...
        for j in 8*s ..< 8*s + min(s, 3) {
            HHElem.addElemToHH(hhElem, i:j-3*s, j:j, leftFrom:7*(j+m)+5, leftTo:7*(j+m+1)+5, rightFrom:7*j+4, rightTo:7*j+5, koef:s == 2 && j == 8*s ? 2 : 1, noZeroLenL:true)
        ...
        for j in 11*s ..< 11*s + min(s, 3) {
            HHElem.addElemToHH(hhElem, i:j-5*s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+6, rightTo:7*j+6, koef:s == 2 && j == 11*s ? 2 : 1, noZeroLenL:true)
            if j < 11*s + min(s, 2) {
