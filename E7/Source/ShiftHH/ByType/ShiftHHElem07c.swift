...
final class ShiftHHElem07c : ShiftHHElem {
    ...
    override func oddShift1(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        var j = 4*s + myModS(3)
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+2, rightTo:7*j+3, koef:-1)
        j += 3*s
        HHElem.addElemToHH(hhElem, i:j-s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+5, rightTo:7*j+5, koef:1)
    }
    ...
    override func oddShift11(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        let j = myModS(2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+2, leftTo:7*(j+m+2), rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift12(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        let j = myModS(2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+1, rightFrom:7*j, rightTo:7*(j+1), koef:1)
    }
    ...
    override func oddShift13(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        let j = myModS(2)
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+3, leftTo:7*(j+m+1)+6, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift15(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        let j = myModS(2)
        HHElem.addElemToHH(hhElem, i:j, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j, rightTo:7*j, koef:-1)
    }
    ...
    override func oddShift16(_ hhElem: HHElem, degree: Int, shift: Int, n: Int, s: Int, m: Int, ell: Int) {
        ...
        var j = 3*s + 1
        HHElem.addElemToHH(hhElem, i:j+3*s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+1, rightTo:7*j+6, koef:1)
        j += 2*s
        HHElem.addElemToHH(hhElem, i:j+s, j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+6, rightFrom:7*j+3, rightTo:7*j+6, koef:-1)
    }
