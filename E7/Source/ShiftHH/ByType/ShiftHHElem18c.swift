...
final class ShiftHHElem18c : ShiftHHElem {
    ...
    override func oddShift1(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+1, leftTo:7*(j+m+2), rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift4(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+2, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+3, leftTo:7*(j+m+1)+6, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift6(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+3, rightFrom:7*j, rightTo:7*(j+1), koef:1)
    }
    ...
    override func oddShift7(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+5, leftTo:7*(j+m+1)+6, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
    ...
    override func oddShift8(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m)+6, leftTo:7*(j+m+1)+5, rightFrom:7*j, rightTo:7*(j+1), koef:1)
    }
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        let j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1), leftTo:7*(j+m+1)+6, rightFrom:7*j, rightTo:7*(j+1), koef:-1)
    }
