...
final class ShiftHHElem05c : ShiftHHElem {
    ...
    override func oddShift5(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        var j = 0
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+4, leftTo:7*(j+m+1)+5, rightFrom:7*j, rightTo:7*(j+1), koef:-1, noZeroLenR:true)
        j += s
    ...
    override func oddShift7(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+2, leftTo:7*(j+m+1)+2, rightFrom:7*j, rightTo:7*(j+1), koef:-1, noZeroLenR:true)
        j += s
        HHElem.addElemToHH(hhElem, i:2*s+myModS(j+1), j:j, leftFrom:7*(j+m+1)+4, leftTo:7*(j+m+1)+4, rightFrom:7*j, rightTo:7*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift9(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:+myModS(j+1), j:j, leftFrom:7*(j+m+1)+5, leftTo:7*(j+m+1)+5, rightFrom:7*j, rightTo:7*(j+1), koef:-1, noZeroLenR:true)
    }
    ...
    override func oddShift16(_ hhElem: HHElem, s: Int, m: Int, ell: Int) {
        ...
        j += s
        HHElem.addElemToHH(hhElem, i:j+4*s, j:j, leftFrom:7*(j+m)+5, leftTo:7*(j+m+1)+5, rightFrom:7*j, rightTo:7*j+5, koef:-1, noZeroLenL:true)
