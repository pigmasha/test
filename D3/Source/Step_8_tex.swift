...
struct Step_8_tex {
    ...
    private static var genToTex: [String: String] = [
        "c12": "c_{12}", "c23": "c_{23}", "c31": "c_{31}",
        "z1": "z_1", "w": "w", "x1": "x_1", "x3": "x_3", "w23": "w_{23}", "w31": "w_{31}", "w12": "w_{12}",
        "x12": "x_{12}", "x23": "x_{23}", "x31": "x_{31}", "u1": "u_1", "u2": "u_2",
        "x1_h": "\\hat{x}_1", "x3_h": "\\hat{x}_3",
        "w23_h": "\\hat{w}_{23}", "w31_h": "\\hat{w}_{31}", "w12_h": "\\hat{w}_{12}",
        "e": "e", "e1_h": "\\hat{e}_1", "e2_h": "\\hat{e}_2",
        "u1_h": "\\hat{u}_1", "u2_h": "\\hat{u}_2", "q": "\\zeta"
    ]
